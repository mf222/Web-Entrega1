...
* <tt><b>CREATE</b></tt>: Click al final de la página, en <tt>New Explorer</tt> al final de la página. LLevara a una página con un form donde se deben ingresar los parámetros. Finalmente click en el botón <tt>Create Explorer</tt>.
* <tt><b>READ</b></tt>: Para ver cada versión, basta con hacer click en <tt>Show</tt>.
* <tt><b>UPLOAD</b></tt>: Para editar una versión, se debe hacer click en <tt>Edit</tt>, lo que llevara a un form con los atributos correspondientes.
* <tt><b>DELETE</b></tt>: Click en el botón <tt>Destroy</tt>.
